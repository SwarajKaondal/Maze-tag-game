...
function renderModels() {
  ...
  function makeModelTransform(currModel) {
    if (currModel.id === "Frog") {
      currModel.xAxis = vec3.fromValues(...Object.values(currentEnemyPosition.angle));
      console.log(...Object.values(currentEnemyPosition.angle));
    }
...
function main(blockLength) {
  defaultEye = vec3.fromValues(blockLength / 2, blockLength / 2, blockLength / 2);
